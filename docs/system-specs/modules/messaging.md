...
revoked wake, and does not mark the hook accepted. Dashboard performs the
...
leave an accepted monitor wake in flight. Directive consumption occurs
...
scheduler propagates that typed result unchanged.
